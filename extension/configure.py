...
builder.options.add_option('--mms-path', type=str, dest='mms_path', default='../../../alliedmodders/mmsource-1.10',
                       help='Path to Metamod:Source')
builder.options.add_option('--sm-path', type=str, dest='sm_path', default='../../../alliedmodders/sourcemod',
...
builder.options.add_option('-s', '--sdks', default='tf2', dest='sdks',
